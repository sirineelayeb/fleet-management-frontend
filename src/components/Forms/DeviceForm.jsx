    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <input
          ...
          placeholder="e.g., ESP32_001 or GPS_001"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            <option value="esp32">ESP32 (WiFi Scanner)</option>
            <option value="gps">GPS Tracker</option>
            <option value="sim808">SIM808 (GPS+GSM)</option>
          </select>
        </div>
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 mt-1">
          {formData.truckId ? 'Device will be assigned to the selected truck.' : 'Leave blank to keep unassigned.'}
        </p>
      </div>
