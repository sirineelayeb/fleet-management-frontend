        ...
        <div className="flex gap-2">
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 pl-9 text-sm"
            />
          ...
          <div className="flex justify-between items-start gap-3">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-xs font-semibold text-green-900">Location Selected</p>
              </div>
              
              {placeName && (
                <div className="mb-2">
                  <label className="text-xs text-green-700 font-medium">PLACE NAME</label>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="text-xs text-green-700 font-medium">LATITUDE</label>
                  <p className="text-sm font-mono font-semibold text-green-900 mt-0.5">
                    {position.lat.toFixed(6)}
                  </p>
                </div>
                <div>
                  <label className="text-xs text-green-700 font-medium">LONGITUDE</label>
                  <p className="text-sm font-mono font-semibold text-green-900 mt-0.5">
            ...
            <button
              ...
              className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center gap-1 text-sm font-medium transition-colors shadow-sm"
            >
